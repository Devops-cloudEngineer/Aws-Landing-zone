  ...
  default     = [
    {
      ...
      noncurrent_version_transition       = [{ noncurrent_days = 40, storage_class = "GLACIER" }]
      abort_incomplete_multipart_upload_days = 7
      filter                              = { prefix = "lambda-builds/" }
    }
  ]
}
  ...
  default     = {
		rule = {
			apply_server_side_encryption_by_default = {
				kms_master_key_id = "arn:aws:kms:eu-west-1:533267235239:key/0218c72d-7372-4849-a871-5a08ea77da43"
